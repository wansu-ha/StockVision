> 작성일: 2026-03-11 | 상태: 구현 완료 | Unit 2 잔여
...
| F9 | 포트 4020 점유 시 시작 실패 + 로그 기록 후 종료 |
...
| 포트 스쿼팅 (악성 앱이 4020 선점) | 중간 | 포트 점유 감지 + 로그 경고 | 프론트가 진짜 서버인지 검증 불가 — 로컬 앱 공통 한계 |
