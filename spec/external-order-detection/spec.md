...
| 의존 대상 | 상태 | 비고 |
|-----------|------|------|
| System Trader Phase 1-2 | 완료 | OrderIntent, IntentStore 존재 |
| System Trader Phase 3 (reconciler) | **미완료** | open order / fill reconciliation 필요 |
| 브로커 API (미체결 조회) | 완료 | `adapter.get_open_orders()` 존재 |

**선행 작업: System Trader Phase 3 — reconciler 구현**
...
- 구체적으로: `broker_order_id`가 IntentStore의 어떤 intent와도 매칭되지 않는 주문
