...
async def register_cloud_token(body: CloudTokenRequest) -> dict[str, Any]:
...
async def auth_status() -> dict[str, Any]:
    ...
    return {
        ...
        "data": {
            ...
            "cloud_token_preview": (access_token[:12] + "..." if access_token else None),
        },
        "count": 1,
    }
