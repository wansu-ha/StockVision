...
| F2 | staleTime 설정 | 다수 (6+ 파일) | ⚠️ 15/20+ 쿼리 설정 (7건 추가, 2026-03-18) |
...
- [x] ErrorBoundary 라우트 리셋 (2026-03-18) + staleTime 7건 추가 (잔여 ~5건)
- [x] 약관 동의/열람/버전관리 (L1~L3) 완료 (2026-03-16)
- [ ] 품질 이슈 잔여: F2 staleTime ~5건, F3 닉네임, Q5 공휴일
...
#### T1-1. engine-live-execution (IndicatorProvider) — 🔴 미착수
...
Phase A (Week 1-3) — ✅ 완료 ═════════════════════════════════════
  ...
  ├─ [A6] frontend-quality F1, F2 (대부분)   ⚠️ F2 잔여~5건, F3 미구현
  ├─ [A7] legal L1→L2→L3                   ✅
...
T1 (Week 4-6) ════════════════════════════════════════════════════
  ...
  Week 3-4 (병렬):
  ┌─ [T1-1] engine-live-execution             🔴 미착수
